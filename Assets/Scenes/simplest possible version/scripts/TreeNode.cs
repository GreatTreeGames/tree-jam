...
namespace Scenes.simplest_possible_version.scripts
{
    public class TreeNode : MonoBehaviour
    {
        ...
        public void VariableSpawnStep(float bias)
        {
            ...
            {
                SpawnBranch(Random.Range(branchlengthminimum + (i *branchlengthgainrate), branchlengthmaximum), Random.Range(-branchspreadrange* (i+branchspreadgainrate), branchspreadrange * (i+1)));
            }
            // SetChildrenArray();
        }
